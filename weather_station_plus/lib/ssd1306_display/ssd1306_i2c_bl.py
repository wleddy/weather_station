...
# BL - 12/4/2020 - I modified this to allow passing the i2c address (addr)
#   because the version of micropython I'm running did not work when the hex
#   equivelent as passed in.
...
class Display:
    ...
    def __init__(self,
        ...
        self.i2c = I2C(scl = Pin(scl_pin_id, Pin.OUT),
                               sda = Pin(sda_pin_id),
                               freq = freq)
        self.display = SSD1306_I2C(width, height, self.i2c, addr=addr)
    ...
    def show_text(self, text, x = 0, y = 0, clear_first = False, show_now = True, hold_seconds = 0):
    ...
    def show_text_wrap(self, text,
                       ...
                       clear_first = False, show_now = True, hold_seconds = 0):
