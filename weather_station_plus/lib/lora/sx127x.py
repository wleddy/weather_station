...
class SX127x:
    ...
    def __init__(self,
        ...
        self._spi = spi
        self._pin_ss = Pin(ss, Pin.OUT, Pin.PULL_DOWN)
        self._pin_ss.value(1) # don't listen
        self._pins = pins
    ...
    def println(self, msg, implicit_header = False):
        # write method is passed message var, which does not exist if msg is not type str
        if msg:
            message = msg
